      ...
      <div className="grid-container py-16 md:py-20">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10 mb-16 pb-12 border-b border-white/10">
          <div className="max-w-[320px]">
            <Link href="/" className="inline-block hover:opacity-80 transition-opacity">
              <Image src="/images/floats-transparent.png" alt="Floats" width={300} height={80} className="h-7 md:h-8 w-auto" />
            </Link>
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="text-white/40 hover:text-white transition-colors p-1" aria-label="X / Twitter">
            ...
            <a href="#" className="text-white/40 hover:text-white transition-colors p-1" aria-label="LinkedIn">
            ...
            <a href="#" className="text-white/40 hover:text-white transition-colors p-1" aria-label="GitHub">
