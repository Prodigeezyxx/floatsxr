...
const plans = [
  ...
  },
  {
    ...
    cta: { label: "Book a realmspace demo", href: "/get-a-demo", variant: "primary" as const },
    features: [
      ...
      <section className="bg-ecru py-24 md:py-32">
        ...
        <div className="grid-container">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-x-6 gap-y-3 text-sm">
            <Link href="/plans-and-pricing/bundled-activation" className="text-cobalt hover:underline">Bundled activation details</Link>
            <Link href="/plans-and-pricing/intelligence-layer-only" className="text-cobalt hover:underline">Intelligence layer details</Link>
            <Link href="/plans-and-pricing/api-plans" className="text-cobalt hover:underline">API plan details</Link>
            <Link href="/plans-and-pricing/retainer" className="text-cobalt hover:underline">Retainer details</Link>
          </div>
        </div>
      </section>
