  ...
  return (
    <>
      <HeroGradient
        ...
        ctaHref="#resource-library"
      />
      <section id="resource-library" className="scroll-mt-24 bg-white py-20 md:py-28">
      ...
      <ConversionPanel
        headline="Looking for a specific resource or measurement answer?"
        ctaLabel="Ask the Floats team"
